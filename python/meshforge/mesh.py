...
def heightmap_to_mesh(
    ...
    *,
    ...
    # pixel_mm_y defaults to pixel_mm (square cells); pass a separate value to
    # scale rows (Y) independently — downsample_heights uses this so an
    # anisotropic shrink still preserves each physical side length exactly.
